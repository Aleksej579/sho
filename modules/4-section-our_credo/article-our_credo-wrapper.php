<article class="article-our_credo-wrapper">
    ...
    <div class="our_credo-loreum_wrapper">
        <p>
            <?php
                for ($loreum = 0; $loreum<3; $loreum++) {
                    echo "<span class='loreum-first_left'>I love to read this !</span>";
                    echo "<span class='loreum-first_right'>Share with: <i class=\"fa fa-twitter\" aria-hidden=\"true\"> </i><i class=\"fa fa-facebook\" aria-hidden=\"true\"></i> <i class=\"fa fa-google-plus\" aria-hidden=\"true\"></i></span><br><br>";
                    echo "<span class='loreum-main_text'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed placerat luctus orci, quis lobortis nisi consectetur non. Vestibulum ante ipsum primis in fauclbus orcl luctus et ultrlces posuere cubilla  Curae; Curabitur fermentum id lare eget ultricles. Cras ut ullamcorper urna. vestibulum eu dictum ante. Proln vitae augue dul. Donec ut maximus tellus. Nulla tincldunt umae fells, eu efficttur leo lacinia ac. Nunc rhoncus bus.</span><br><br>";
                    echo "<span class='loreum-last_left'><i class=\"fa fa-clock-o\" aria-hidden=\"true\"></i> 2 days ago  <i class=\"fa fa-user\" aria-hidden=\"true\"></i> kenanhamidic <i class=\"fa fa-comment\" aria-hidden=\"true\"></i> 2 comments</span>";
                    echo "<span class='loreum-last_right'>READ MORE</span><br><br><br><br><br><br><br><br";
                }
            ?>
        </p>
        <p class="gradient"></p>
    ...
    <button class="our_credo-btn">Посетить наш блог</button>
</article>